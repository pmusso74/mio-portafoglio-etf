...
if not st.session_state.portfolio:
    ...
    with col_info:
        ...
        st.progress(min(mensilità / 24, 1.0)) # ProgressBar su 2 anni
    ...
    with col_pie:
        if total_val_portafoglio > 0:
            ...
            if not df_pie.empty:
                fig_p = px.pie(df_pie, values='Valore', names='Asset', hole=0.4, title="Distribuzione Reale del Portafoglio")
